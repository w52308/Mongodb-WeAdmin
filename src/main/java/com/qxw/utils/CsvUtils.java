...
public class CsvUtils {
    ...
    public static void appendDate(File csvFile, StringBuffer sb) {
        try {
            BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(csvFile, true), "GBK"),
                1024);
    ...
    public static void main(String[] args) {
        ...
        File csvFile = createFileAndColName(
            "E:\\eclipseWork\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp1\\wtpwebapps\\shakeExternal\\impCsv",
            "test.csv", colNames);
        StringBuffer sb = new StringBuffer();
